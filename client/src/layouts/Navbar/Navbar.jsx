...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      <h1  style={{color:"#0E86D4"}} onClick={homeHandler}>EDU. CENTER</h1>
      ...
      <div className="auth">
        {isUserAuthenticated ? (
          <button style={{backgroundColor:"#0E86D4"}} onClick={logoutHandler}> Logout</button>
        ) : (
          <button style={{backgroundColor:"#0E86D4"}} onClick={registerHandler}>Register</button>
        )}
         {!isUserAuthenticated && ( 
            <button style={{backgroundColor:"#0E86D4"}} onClick={loginHandler}>Login</button>
         )}
         
        <div>
          {isUserAuthenticated && (
            <button style={{backgroundColor:"#0E86D4"}} onClick={dashboardHandler}>Student Dashboard</button>
          )}
        </div>
      </div>
    </nav>
