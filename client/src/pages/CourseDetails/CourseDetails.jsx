          ...
          <div className="section">
            <div className="topSection">
                ...
                {randomEnrollment === "Inprogress" && (
                  <div className="progressBarContainer">
                    <div
                      ...
                      style={{ width: `${randomPercentage}%`,backgroundColor:"#0E86D4" }}
                    >
                      {randomPercentage}%
                    </div>
                  </div>
              ...
              <div className="imgSection">
                ...
                />
                {!enroll ? (
                  <button style={{backgroundColor:"#0E86D4",border:"none" ,borderRadius:'5px' }} onClick={enrollmentHandler}>Enroll</button>
                ) : (
                  <button style={{backgroundColor:"#0E86D4",border:"none" ,borderRadius:'5px' }} disabled>Already Enrolled</button>
                )}
              </div>
            </div>
            <h2>SYLLABUS</h2>
            <button
              ...
              style={{backgroundColor:'#0E86D4',border:"none",borderRadius:'5px'}}
            >
            ...
            >
              {syllabusData.map((item, index) => (
                <div key={index}>
                  <h3 style={{textTransform:"uppercase"}}>WEEK {item.week}</h3>
                  <h3 style={{textTransform:"uppercase"}}>TOPIC : {item.topic}</h3>
